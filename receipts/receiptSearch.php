...
<body>
  ...
  <div class="container">
    ...
    <h2>YAM Database Receipt Search</h2>
    <form class="form-horizontal" action="receiptSearch.php" method="post" autocomplete="off">
      <div class="form-group">
        <label class="control-label col-sm-2" for="id">Receipt ID:</label>
        <div class="col-sm-10">
        <input type="text" class="form-control" placeholder="Enter Receipt ID" required autocomplete="off" name="id"/>
        </div>
      </div>
